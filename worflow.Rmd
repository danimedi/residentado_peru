...
save_final_dat <- function(df) {
  path <- paste0(
    "data/clean/deidentified/completos/peru-COMPLETO-2013-2020_",
    Sys.Date(),
    ".rds"
  )
  saveRDS(df, path)
...
# write_csv(dat_final, "data/clean/identified/peru-COMPLETO-2013-2020.csv")
# saveRDS(dat_final, "data/clean/identified/peru-COMPLETO-2013-2020.rds")
```
...
```{r}
dat1 <- read_csv("data/clean/identified/peru-COMPLETO-2013-2020.csv",
...
```{r}
dat <- read_rds("data/clean/deidentified/peru-COMPLETO-2013-2020.rds")
head(dat)
```
...
lookup_postulantes <- c(
  ...
  "SUSMP" = "USMP"
) # missing: "N FEURNMASNMDEZ", "ROSARUIORP", "SABINUANMSM"
